...
const quizSet = [
    ...
    { q: '2.この地名はなんて読む？', c: ['かめいど', 'かめと', 'かめど'], b:'正解！正解は「かめいど」です！', r: '不正解。正解は「かめいど」です！' },
    { q: '3.この地名はなんて読む？', c: ['こうじまち', 'かゆまち', 'おかとまち'], b:'正解！正解は「こうじまち」です！', r: '不正解。正解は「こうじまち」です！' },
    { q: '4.この地名はなんて読む？', c: ['おなりもん', 'おかどもん', 'ごせいもん'], b:'正解！正解は「おなりもん」です！', r: '不正解。正解は「おなりもん」です！' },
    { q: '5.この地名はなんて読む？', c: ['とどろき', 'たたりき', 'たたら'], b:'正解！正解は「とどろき」です！', r: '不正解。正解は「とどろき」です！' },
    { q: '6.この地名はなんて読む？', c: ['しゃくじい', 'いじい', 'せきこうい'], b:'正解！正解は「しゃくじい」です！', r: '不正解。正解は「しゃくじい」です！' },
    { q: '7.この地名はなんて読む？', c: ['ぞうしき', 'ざっしょく', 'ざっしき'], b:'正解！正解は「ぞうしき」です！', r: '不正解。正解は「ぞうしき」です！' },
    { q: '8.この地名はなんて読む？', c: ['おかちまち', 'ごしろちょう', 'みとちょう'], b:'正解！正解は「おかちまち」です！', r: '不正解。正解は「おかちまち」です！' },
    { q: '9.この地名はなんて読む？', c: ['ししぼね', 'しこね', 'ろっこつ'], b:'正解！正解は「ししぼね」です！', r: '不正解。正解は「ししぼね」です！' },
    { q: '10.この地名はなんて読む？', c: ['こぐれ', 'こしゃく', 'こばく'], b:'正解！正解は「こぐれ」です！', r: '不正解。正解は「こぐれ」です！'},
];
